...
//Load the file
loader.load(
    `./Documents/robot_shark/scene.gltf`,
    function (gltf) {
...
camera.position.z = objToRender === "robot_shark" ? 25 : 500;
...
const ambientLight = new THREE.AmbientLight(0x333333, objToRender === "robot_shark" ? 5 : 1);
scene.add(ambientLight);

//This adds controls to the camera, so we can rotate / zoom it with the mouse
if (objToRender === "robot_shark") {
...
function animate() {
    ...
    //Make the eye move
    if (object && objToRender === "robot_shark") {
...
//add mouse position listener, so we can make the item move
